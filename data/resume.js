export const profile = {
  ...
  phone: '848-391-8742',
  linkedin: 'https://linkedin.com',   // ← replace with your real URL
  github: 'https://github.com',       // ← replace with your real URL
  portfolio: 'https://portfolio.com', // ← replace with your real URL
}

export const stats = [
  { num: '5+',  label: 'Years Experience' },
  { num: '30%', label: 'Faster Load Times' },
  { num: '99%', label: 'Uptime Maintained' },
  { num: '28%', label: 'Faster Image Delivery' },
]
...
export const projects = [
  // Add your projects here as you build them! Example:
  // {
  //   title: 'Blog App',
